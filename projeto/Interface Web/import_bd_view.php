...
<div class="row">
	<div class="col-lg-offset-3 col-lg-6">
		...
		<input id="students" name="input23[]" type="file" multiple class="file-loading">
		<br>
		<label class="control-label">Ficheiro de professores que lecionam a UC</label>
		<input id="teachers" name="input23[]" type="file" multiple class="file-loading">
		<br>
		<label class="control-label">Ficheiro de salas de exame</label>
		<input id="exam" name="input23[]" type="file" multiple class="file-loading">
		<br>
	</div>
</div>
